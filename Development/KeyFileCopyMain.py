...
def submitClusterJob(experiment_path,data_path,reserved_memory,maximum_memory,queue):
    ...
    sh_file.write('#SBATCH -o ' + experiment_path+'/logs/Key_'+job_ref+'.o\n')
    sh_file.write('#SBATCH -e ' + experiment_path+'/logs/Key_'+job_ref+'.e\n')

    this_file_path = os.path.dirname(os.path.realpath(__file__))
    sh_file.write('srun python ' + this_file_path + '/KeyFileCopyJob.py ' + experiment_path +" "+ str(data_path)+ '\n')
    sh_file.close()
